...
extension Level2ViewController {
    ...
    func initAllQuestions() -> [SecondLevelQuestion] {
        ...
        resultArray.append(SecondLevelQuestion(question: "Harsh man", correctAnswer: "Суровый человек", allAnswers: ["Суровый человек", "Гордый человек", "Злой человек", "Бедный человек"]))
        ...
        resultArray.append(SecondLevelQuestion(question: "Is not avaliable", correctAnswer: "Недоступен", allAnswers: ["Невозможен", "Невидимый", "Неприемлемый", "Недоступен"]))
        ...
        resultArray.append(SecondLevelQuestion(question: "Spaceship", correctAnswer: "Космический корабль", allAnswers: ["Спутник", "Космический корабль", "Планета", "Ракета"]))
