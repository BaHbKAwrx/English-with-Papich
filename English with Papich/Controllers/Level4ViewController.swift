...
extension Level4ViewController {
    ...
    func initAllQuestions() -> [ForthLevelQuestion] {
        ...
        resultArray.append(ForthLevelQuestion(question: "Суровый мужик", correctAnswer: "Harsh man", allAnswers: ["Harsh man", "Noble man", "Evil man", "Poor man"]))
        ...
        resultArray.append(ForthLevelQuestion(question: "Космолет", correctAnswer: "Spaceship", allAnswers: ["Satellite", "Spaceship", "Earth", "Missile"]))
