...
extension Level1ViewController {
    ...
    func initAllQuestions() -> [FirstLevelQuestion] {
        ...
        resultArray.append(FirstLevelQuestion(sound: "harsh man", correctAnswer: "Суровый человек", allAnswers: ["Суровый человек", "Гордый человек", "Злой человек", "Бедный человек"]))
        ...
        resultArray.append(FirstLevelQuestion(sound: "hidden", correctAnswer: "Скрытый", allAnswers: ["Разбитый", "Внутренний", "Широкий", "Скрытый"]))
        ...
        resultArray.append(FirstLevelQuestion(sound: "kill", correctAnswer: "Убить", allAnswers: ["Болеть", "Умение", "Убить", "Чек"]))
        ...
        resultArray.append(FirstLevelQuestion(sound: "next", correctAnswer: "Следующий", allAnswers: ["Последний", "Первый", "Следующий", "Предыдущий"]))
        resultArray.append(FirstLevelQuestion(sound: "non-native", correctAnswer: "Неродной", allAnswers: ["Ненастоящий", "Неопытный", "Непростой", "Не родной"]))
        ...
        resultArray.append(FirstLevelQuestion(sound: "spaceship", correctAnswer: "Космический корабль", allAnswers: ["Спутник", "Космический корабль", "Планета", "Ракета"]))
        resultArray.append(FirstLevelQuestion(sound: "spectacular", correctAnswer: "Захватывающий", allAnswers: ["Спектакль", "Спектр", "Захватывающий", "Конспект"]))
        resultArray.append(FirstLevelQuestion(sound: "stain", correctAnswer: "Пятно", allAnswers: ["Боль", "Дождь", "Сухость", "Пятно"]))
        resultArray.append(FirstLevelQuestion(sound: "stand", correctAnswer: "Стоять", allAnswers: ["Стоять", "Земля", "Группа", "Песок"]))
        resultArray.append(FirstLevelQuestion(sound: "star", correctAnswer: "Звезда", allAnswers: ["Старик", "Звезда", "Комета", "Карлик"]))
        ...
        resultArray.append(FirstLevelQuestion(sound: "to destroy", correctAnswer: "Разрушать", allAnswers: ["Приезжать", "Обманывать", "Разрушать", "Притворяться"]))
        ...
        resultArray.append(FirstLevelQuestion(sound: "ukraine", correctAnswer: "Украина", allAnswers: ["Страна", "Украина", "Город", "Украинец"]))
